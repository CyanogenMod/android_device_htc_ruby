...
adb pull /system/lib/hw/sensors.ruby.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/sensors.ruby.so:system/lib/hw/sensors.ruby.so
EOF
